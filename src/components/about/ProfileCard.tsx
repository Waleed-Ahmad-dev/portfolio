...
export const ProfileCard = () => {
     return (
          <motion.div
               ...
               viewport={{ once: true }}
               transition={{ duration: 0.5 }} // Reduced duration for quicker animation
               className="flex justify-center"
          >
               <div className="relative">
                    {/* Simplified gradient animation with will-change transform */}
                    <motion.div 
                    ...
                    <Card className="relative bg-gradient-to-br from-[#121B2B] to-[#0A0E17] border border-[#1E2A40] rounded-3xl overflow-hidden w-full max-w-md">
                         <CardHeader className="p-0">
                              <div className="relative w-full h-72">
                                   {/* Removed redundant gradient overlay */}
                                   <Image
                                        src="/profile.svg"
                                        alt="Waleed Ahmad"
                                        fill
                                        ...
                                        sizes="(max-width: 768px) 100vw, 384px" // Optimize image sizing
                                   />
                              </div>
                         </CardHeader>
                         <CardContent className="p-6">
                              ...
                              {/* Static specialties list - no runtime calculations needed */}
